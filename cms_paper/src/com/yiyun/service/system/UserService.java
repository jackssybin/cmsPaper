...
public class UserService {
	...
	*/
	public PageData findByOpenId(PageData pd)throws Exception{
		return (PageData)dao.findForObject("UserXMapper.findByOpenid", pd);
	}
	...
	*/
	...
	public void editBaseInfo(PageData pd)throws Exception{
		dao.update("UserXMapper.editBaseInfo", pd);
	}
	/*
	* 换皮肤
	*/
	...
	*/
	...
	public void updateIsReadFlag(PageData pd)throws Exception{
		dao.update("UserXMapper.updateIsReadFlag", pd);
	}
