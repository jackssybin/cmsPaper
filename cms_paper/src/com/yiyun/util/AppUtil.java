...
//		checkParam("registered", pd);
	...
	public static boolean checkParam(String method, PageData pd){
		...
		}else if(method=="judgeUserByUsernmae"){
			paramArray = Const.APP_judgeUser_PARAM_ARRAY;  
			valueArray = Const.APP_judgeUser_VALUE_ARRAY;
		}
	...
	public static Object returnObject(PageData pd, Map map){
		if(null!=pd&&pd.containsKey("callback")){
