 ...
 * 加密过程：对选中的文件加密后更改了文件名_en.epub。 扩展名的加密文件 解密过程：对选中的加密文件（必须扩展名为_en.epub）进行解密 
 */  
public class FileEncrypterUtil {  
  
    public static void main(String args[]) {  
    	FileEncrypterUtil da = new FileEncrypterUtil();  
    	String type="de";
        String pass1 ="D368DFE03120B5DF";// pass.substring(0, 2);  
        String pass2 ="92A8FD8FEC2F0746";// pass.substring(2, 4);  
        String pass3 ="BE6E5ADD368DFE03";// pass.substring(4);  
        System.out.println(pass1);  
        System.out.println(pass2);  
        System.out.println(pass3);  
        if (type.equals("en"))  
            da.encrypt(new File("d:\\encry.epub"), da.md5s(pass1) + da.md5s(pass2)  
                    + da.md5s(pass3));  
        else  
            da.decrypt(new File("d:\\encry_en.epub"), da.md5s(pass1) + da.md5s(pass2)  
                    + da.md5s(pass3));  
    }  
        ...
        try {  
            if (sKey.length() == 48) {  
                ...
                byte[] bytOut = encryptByDES(encryptByDES(encryptByDES(bytIn,  
                        bytK1), bytK2), bytK3);  
                String fileOut = fileIn.getPath()+"_en";  
