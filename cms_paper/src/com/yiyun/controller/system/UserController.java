...
import com.yiyun.util.GetPinyin;
import com.yiyun.util.NumberUtil;
import com.yiyun.util.ObjectExcelRead;
import com.yiyun.util.ObjectExcelView;
...
public class UserController extends BaseController {
	...
	public ModelAndView saveU(PrintWriter out) throws Exception{
		...
		pd.put("PASSWORD", new SimpleHash("SHA-1", USERNAME, pd.getString("PASSWORD")).toString());
		if(null == userService.findByUId(pd)){
			pd.put("INVITE_CODE", NumberUtil.getInviteCodeByUser(USERNAME));
	...
	public void downExcel(HttpServletResponse response)throws Exception{
		...
		FileDownload.fileDownload(response, PathUtil.getClasspath() + Const.SYS_IMAGE_REAL_PATH + "Users.xls", "Users.xls");
	...
	public ModelAndView readExcel(
		...
		if (null != file && !file.isEmpty()) {
			String filePath = PathUtil.getClasspath() + Const.SYS_IMAGE_REAL_PATH;								//文件上传路径
