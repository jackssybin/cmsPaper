...
import com.yiyun.service.system.AddressService;
...
public class AddressController extends BaseController {
	...
	String menuUrl = "address/list.do"; //菜单地址(权限地址)
	String logMenu ="菜单名称";
	...
	public ModelAndView save() throws Exception{
		logBefore(logger,logMenu, "新增Address");
	...
	public void delete(PrintWriter out){
		logBefore(logger,logMenu, "删除Address");
		PageData pd = new PageData();
		try{
			pd = this.getPageData();
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger,logMenu, "修改Address");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
	...
	public ModelAndView list(Page page){
		logBefore(logger,logMenu, "列表Address");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		try{
			pd = this.getPageData();
			String USER_ID=SessionUtils.getSessionUserId();
	...
	public ModelAndView goAdd(){
		logBefore(logger,logMenu, "去新增Address页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public ModelAndView goEdit(){
		logBefore(logger,logMenu, "去修改Address页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public Object deleteAll() {
		logBefore(logger,logMenu, "批量删除Address");
		PageData pd = new PageData();		
