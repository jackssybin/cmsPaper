package com.yiyun.controller.video;
...
public class VideoPlayController extends JFrame {
	...
	public VideoPlayController() { // 构造函数
		...
		openFile.addActionListener(new ActionListener() { //打开文件按钮事件处理
			public void actionPerformed(ActionEvent event) {
				...
				int result = fileChooser.showOpenDialog(VideoPlayController.this);//显示对话框				
		...
		openURL.addActionListener(new ActionListener() { //打开URL按钮事件处理
			public void actionPerformed(ActionEvent event) {
				String addressName =JOptionPane.showInputDialog(VideoPlayController.this, "输入URL地址");
				if (addressName != null)
