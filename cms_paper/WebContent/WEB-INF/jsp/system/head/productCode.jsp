...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="static/css/productCode.css" />
		  	...
		  	<div class="commitbox_inner">
		        <div class="commitbox_top">
		        	...
		        	<table>
		        		...
		        		<tr>
		        			<td style="padding-left: 16px;text-align: right;">默认值：</td><td><input name="ddefault" id="ddefault" type="hidden" value="" disabled="disabled" placeholder="后台附加值时生效" title="默认值"/></td>
	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		<table style="margin-top: 10px;" border="0">
			<tr>
				...
				<td style="width:110px;text-align: right;">自定义主键:：</td>
				<td><input type="text" name="primaryIndexId" id="primaryIndexId" value="no" placeholder="这里输入自定义主键" style="width:60px" title="自定义主键"/></td>
			</tr>
		</table>
		<table border="0">
			<tr>
				...
				<td><input type="text" name="tabletop" id="tabletop" value="SYS_" placeholder="这里输入表前缀" style="width:60px" title="表前缀"/></td>
				<td style="width:76px;text-align: right;">菜单名称:：</td>
				<td><input type="text" name="logMenu" id="logMenu" value="菜单名称" placeholder="这里输入表菜单名称" style="width:60px" title="菜单名称"/></td>
			</tr>
		</table>
