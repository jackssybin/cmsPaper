					...
					<div class="row">
						...
						<form  action="menu/${MSG }.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<label style="float:left;padding-left: 8px;padding-top:7px;" id="Select-Type">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<label style="float:left;padding-left: 8px;padding-top:7px;" id="Select-Status">
