...
<!-- jsp文件头和头部 -->
	...
	<script type="text/javascript">
		...
		function parentReload(){
			if( 'change' == "''"+${MSG}+"''"){
				parent.location.href="<%=basePath%>menu/list.do?MENU_ID="+${MENU_ID};
			}
		}
		parentReload();
	</script>
...
<body class="no-skin">
									...
									<tr>
										...
										<td class='center'>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="red" href="javascript:delmenu('${menu.MENU_ID }','${menu.PARENT_ID}');">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline pos-rel">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														...
														<li><a href="javascript:delmenu('${menu.MENU_ID }','${menu.PARENT_ID}');" class="tooltip-error" data-rel="tooltip" title="Delete">
	...
	<script type="text/javascript">
		...
		//删除
		function delmenu(MENU_ID,PARENT_ID){
			bootbox.confirm("确定要删除此菜单吗?", function(result) {
				if(result) {
					var url = "<%=basePath%>menu/del.do?MENU_ID="+MENU_ID+"&guid="+new Date().getTime();
					top.jzts();
					$.get(url,function(data){
						
						if("success" == data){
							
							window.location.href="<%=basePath%>menu/list.do?MENU_ID="+PARENT_ID;
						}else if("false" == data){
							top.hangge();
							bootbox.dialog({
