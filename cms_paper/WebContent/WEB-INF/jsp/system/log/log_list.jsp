...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">日志内容</th>
									<th class="center">日志菜单</th>
								...
								<c:when test="${not empty varList}">
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.LOG_USER}</td>
											<td class='center'>${var.LOG_TIME}</td>
											<td class='center'>${var.LOG_CONTENT}</td>
											<td class='center'>${var.LOG_MENU}</td>
											<td class='center'>${var.LOG_STATUS}</td>
										</tr>
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<a class="btn btn-sm btn-success" onclick="logScroll();">下拉滚动刷新</a>
								</td>
	...
	<script type="text/javascript">
		...
		function logScroll(){
			window.location.href="log/logScroll.do";
		}
