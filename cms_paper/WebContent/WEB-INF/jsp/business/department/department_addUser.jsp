				...
				<div class="row">
					...
					<form action="department/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>								
								<td style="width:100px;text-align: right;padding-top: 13px;">角色列表:</td>
							...
							<c:choose>
								<c:when test="${not empty userList}">
									...
									<c:forEach items="${departmentUserList}" var="cu" varStatus="vs">
...
<!-- /.main-container -->
    ...
    <script type="text/javascript" charset="utf-8" src="lang/zh-cn/zh-cn.js"></script>
		...
		function save(){
			...
			var url = "<%=basePath%>department/addUser.do?userIdList="+str+"&department_id="+department_id;
			  <%-- window.location.href='<%=basePath%>department/addUser.do?userIdList='+str+'&department_id='+department_id; --%>
